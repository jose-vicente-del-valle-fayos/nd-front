...
const Administracion = () => {
    ...
    return (
        <main className={"fade-in"}>
            <Helmet>
                <title>Bitácora • Administración</title>
                <meta name="description" content={"Administración de Bitácora."}/>
                <meta property="og:title" content={"Bitácora • Administración"}/>
                <meta property="og:description" content={"Administración de Bitácora."}/>
