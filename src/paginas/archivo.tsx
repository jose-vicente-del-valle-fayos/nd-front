...
const Archivo = () => {
    ...
    return (
        <main className={"fade-in"}>
            <Helmet>
                <title>Bitácora • Archivo</title>
                <meta name="description" content={"Todas las entradas de Bitácora."}/>
                <meta property="og:title" content={"Bitácora • Archivo"}/>
                <meta property="og:description" content={"Todas las entradas de Bitácora."}/>
