...
const Aviso = () => {
    return (
        <main className={"fade-in"}>
            <Helmet>
                <title>Bitácora • Aviso</title>
                <meta name="description" content={"Aviso de Bitácora."}/>
                <meta property="og:title" content={"Bitácora • Aviso"}/>
                <meta property="og:description" content={"Aviso de Bitácora."}/>
            ...
            <article>
                ...
                <p>La titularidad de este sitio web, https://bitácora.es, (en adelante, sitio web) la tiene
                    John Smith, con NIF: 01234567-Z. Puede usted contactar con él desde la sección
                ...
                <p>El objeto de las presentes condiciones generales de uso (en adelante, condiciones) es regular el
                    ...
                    servicios).</p>
                <p>bitácora.es se reserva la facultad de modificar, en cualquier momento y sin aviso
                    ...
                    bitácora.es pueda interrumpir, desactivar y/o cancelar cualquiera de estos elementos
                ...
                <p>El acceso, la navegación y uso del sitio web, así como por los espacios habilitados para
                    interactuar entre los usuarios, y el usuario y bitácora.es, como los comentarios y/o
                ...
                <p>El sitio web de bitácora.es proporciona gran diversidad de información, servicios y
                ...
                <ul>
                    <li>Un uso de la información, contenidos y/o servicios y datos ofrecidos por
                        bitácora.es sin que sea contrario a lo dispuesto por las presentes condiciones, la
                    ...
                    <li>La veracidad y licitud de las informaciones aportadas por el usuario en los formularios
                        extendidos por bitácora.es para el acceso a ciertos contenidos o servicios
                        ofrecidos por el sitio web. En todo caso, el usuario notificará de forma inmediata a
                        bitácora.es acerca de cualquier hecho que permita el uso indebido de la información
                    ...
                    <li>bitácora.es se reserva el derecho de retirar todos aquellos comentarios y
                ...
                <p>En cualquier caso, bitácora.es no será responsable de las opiniones vertidas por los
                ...
                <p>El mero acceso a este sitio web no supone entablar ningún tipo de relación de carácter comercial
                    entre bitácora.es y el usuario.</p>
                <p>Siempre en el respeto de la legislación vigente, este sitio web de bitácora.es se dirige
                    a todas las personas, sin importar su edad, que puedan acceder y/o navegar por las páginas del
                    sitio web.</p>

                <h5>Acceso y navegación</h5>
                <p>bitácora.es no garantiza la continuidad, disponibilidad y utilidad del sitio web, ni de
                    los contenidos o servicios. bitácora.es hará todo lo posible por el buen funcionamiento
                ...
                <p>Tampoco se responsabiliza o garantiza que el contenido o software al que pueda accederse a través
                    ...
                    hardware) del usuario. En ningún caso bitácora.es será responsable por las pérdidas,
                ...
                <p>bitácora.es tampoco se hace responsable de los daños que pudiesen ocasionarse a los
                ...
                <p>Se informa que el sitio web de bitácora.es pone o puede poner a disposición de los
                ...
                <p>La instalación de estos enlaces, directorios y motores de búsqueda en el sitio web tiene por
                    ...
                    mismos.</p>
                <p>bitácora.es no ofrece ni comercializa por sí ni por medio de terceros los productos y/o
                ...
                <p>Asimismo, tampoco garantizará la disponibilidad técnica, exactitud, veracidad, validez o
                    ...
                    enlaces.</p>
                <p>bitácora.es en ningún caso revisará o controlará el contenido de otros sitios web, así
                ...
                <p>bitácora.es no asume ninguna responsabilidad por los daños y perjuicios que pudieran
                    producirse por el acceso, uso, calidad o licitud de los contenidos, comunicaciones, opiniones,
                    productos y servicios de los sitios web no gestionados por bitácora.es y que sean
                ...
                <ul>
                    ...
                    <li>A excepción del hipervínculo, el sitio web en el que se establezca dicho hiperenlace no
                        ...
                        ordenamiento jurídico español, salvo autorización expresa de bitácora.es.
                    </li>
                    <li>El establecimiento del hipervínculo no implicará la existencia de relaciones entre
                        bitácora.es y el titular del sitio web desde el cual se realice, ni el conocimiento
                        y aceptación de bitácora.es de los contenidos, servicios y/o actividades ofrecidos
                        en dicho sitio web, y viceversa.
                    </li>
                </ul>

                <h5>Propiedad intelectual o industrial</h5>
                <p>bitácora.es por sí o como parte cesionaria, es titular de todos los derechos de
                ...
                <p>Todos los derechos reservados. En virtud de lo dispuesto en la Ley de Propiedad Intelectual,
                    ...
                    autorización de bitácora.es.</p>
                <p>El usuario se compromete a respetar los derechos de propiedad intelectual e industrial de
                    bitácora.es. Podrá visualizar los elementos del sitio web o incluso imprimirlos,
                ...
                <p>En caso de que el usuario o tercero considere que cualquiera de los contenidos del sitio web
                    ...
                    comunicarlo inmediatamente a bitácora.es a través de los datos de contacto del apartado
                ...
                <p>bitácora.es se reserva la facultad de presentar las acciones civiles o penales que
                ...
                <p>La relación entre el usuario y bitácora.es se regirá por la normativa vigente y de
