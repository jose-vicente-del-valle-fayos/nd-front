...
import {variantesPagina, convertirFecha, smartyPants, registrarVisita, verificarVisitas} from "../constantes/constantes";
    ...
    return (
        <motion.main initial="initial" animate="in" exit="out" variants={variantesPagina}>
            <Helmet>
                ...
                <meta property="og:title" content={"Nuestro Diario"}/>
                ...
                return (
                    <article key={index}>
                        ...
                        <h3>{convertirFecha(entrada.fecha, true)} • {entrada.visitas === 0 ? "sin visitas" : (entrada.visitas === 1 ? "1 visita" : (entrada.visitas.toLocaleString("es-ES") + " visitas"))}<span className={"alineado-derecha"}><Voz
                            ...
                            url={"https://nuestrodiario.es/entrada/" + entrada.id}/></span>
                        </h3>
                        <Markdown
