    ...
    return (
        <motion.main initial="initial" animate="in" exit="out" variants={variantesPagina}>
            <article>
                ...
                <p>Respetando lo establecido en la legislación vigente, www.nuestrodiario.es (en adelante, también sitio web) se compromete a adoptar las medidas técnicas y organizativas necesarias, según el nivel de seguridad adecuado al riesgo de los datos recogidos.</p>
