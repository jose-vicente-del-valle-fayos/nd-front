...
const Privacidad = () => {
    return (
        <main className={"fade-in"}>
            <Helmet>
                <title>Bitácora • Privacidad</title>
                <meta name="description" content={"Privacidad de Bitácora."}/>
                <meta property="og:title" content={"Bitácora • Privacidad"}/>
                <meta property="og:description" content={"Privacidad de Bitácora."}/>
            ...
            <article>
                ...
                <p>Respetando lo establecido en la legislación vigente, bitácora.es (en adelante, también sitio
                ...
                <p>El responsable del tratamiento de los datos personales recogidos en bitácora.es es John Smith, con NIF: 01234567-Z (en adelante, responsable del tratamiento). Puede usted contactar con él desde la sección de <Link to={"/escribeme"}>escríbeme</Link>.</p>
                ...
                <h5>Categorías</h5>
                <p>Las categorías de datos que se tratan en bitácora.es son únicamente datos identificativos. En ningún caso, se tratan categorías especiales de datos personales en el sentido del artículo 9 del RGPD.</p>

                <h5>Base legal</h5>
                <p>La base legal para el tratamiento de los datos personales es el consentimiento. bitácora.es se compromete a recabar el consentimiento expreso y verificable del usuario para el tratamiento de sus datos personales para uno o varios fines específicos.</p>
                ...
                <p>Los datos personales son recabados y gestionados por bitácora.es con la finalidad de poder facilitar, agilizar y cumplir los compromisos establecidos entre el sitio web y el usuario o el mantenimiento de la relación que se establezca en los formularios que este último rellene o para atender una solicitud o consulta.</p>
                <p>Igualmente, los datos podrán ser utilizados con una finalidad comercial de personalización, operativa y estadística, y actividades propias del objeto social de bitácora.es, así como para la extracción, almacenamiento de datos y estudios de marketing para adecuar el contenido ofertado al usuario, así como mejorar la calidad, funcionamiento y navegación por el sitio web.</p>
                ...
                <p>Sin embargo, debido a que bitácora.es no puede garantizar la inexpugabilidad de internet ni la ausencia total de jaquers u otros que accedan de modo fraudulento a los datos personales, el responsable del tratamiento se compromete a comunicar al usuario sin dilación indebida cuando ocurra una violación de la seguridad de los datos personales que sea probable que entrañe un alto riesgo para los derechos y libertades de las personas físicas. Siguiendo lo establecido en el artículo 4 del RGPD, se entiende por violación de la seguridad de los datos personales toda violación de la seguridad que ocasione la destrucción, pérdida o alteración accidental o ilícita de datos personales transmitidos, conservados o tratados de otra forma, o la comunicación o acceso no autorizados a dichos datos.</p>
                <p>Los datos personales serán tratados como confidenciales por el responsable del tratamiento, quien se compromete a informar de y a garantizar por medio de una obligación legal o contractual que dicha confidencialidad sea respetada por sus empleados, asociados, y toda persona a la cual le haga accesible la información.</p>

                <h5>Derechos derivados</h5>
                <p>El usuario tiene sobre bitácora.es y podrá, por tanto, ejercer frente al responsable del tratamiento los siguientes derechos reconocidos en el RGPD:</p>
                <ul>
                    <li><em>Derecho de acceso</em>: Es el derecho del usuario a obtener confirmación de si bitácora.es está tratando o no sus datos personales y, en caso afirmativo, obtener información sobre sus datos concretos de carácter personal y del tratamiento que bitácora.es haya realizado o realice, así como, entre otra, de la información disponible sobre el origen de dichos datos y los destinatarios de las comunicaciones realizadas o previstas de los mismos.</li>
                    ...
                    <li><em>Derecho de oposición</em>: Es el derecho del usuario a que no se lleve a cabo el tratamiento de sus datos de carácter personal o se cese el tratamiento de los mismos por parte de bitácora.es.</li>
                ...
                <p>Así pues, el usuario podrá ejercitar sus derechos mediante comunicación escrita dirigida al responsable del tratamiento con la referencia “RGPD-https://bitácora.es”, especificando:</p>
                <ul>
                ...
                <p>El sitio web puede incluir hipervínculos o enlaces que permiten acceder a páginas web de terceros distintos de bitácora.es, y que por tanto no son operados por bitácora.es. Los titulares de dichos sitios web dispondrán de sus propias políticas de protección de datos, siendo ellos mismos, en cada caso, responsables de sus propios ficheros y de sus propias prácticas de privacidad.</p>
                <h5>Reclamaciones</h5>
