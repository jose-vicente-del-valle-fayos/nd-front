...
const Escribame = () => {
    ...
    return (
        <main className={"fade-in"}>
            <Helmet>
                <title>Bitácora • Escríbame</title>
                <meta name="description" content={"Escríbame desde Bitácora."}/>
                <meta property="og:title" content={"Bitácora • Escríbame"}/>
                <meta property="og:description" content={"Escríbame desde Bitácora."}/>
